...
import com.cg.onlineplantnursery.util.ExceptionDTOResponse;
...
public class CommonExceptionHandler {
	...
	@ExceptionHandler
		public ResponseEntity<ExceptionDTOResponse> doSomeThingsForFieldsInputs(PlanterIdNotFoundException e) 
	{
		ExceptionDTOResponse dto = new ExceptionDTOResponse();
